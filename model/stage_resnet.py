...
class StageEmbedding(nn.Module):
    def __init__(self, hidden_dim, rWeightFlag):
        super(StageEmbedding, self).__init__()

        self.rWeightFlag = rWeightFlag
        print("Use ReWeight Function: {}".format(self.rWeightFlag))
...
class ResNet(nn.Module):
    def __init__(self, blocks, blockkinds, num_classes, rWeightFlag=False):
        ...
        self.stage_embedding = StageEmbedding(self.hidden_dim, rWeightFlag)
...
def Stage_ResNet18(num_classes, rWeightFlag=False):
    return ResNet(resnet18_params, BasicBlock, num_classes, rWeightFlag)
...
def Stage_ResNet50(num_classes, rWeightFlag=False):
    return ResNet(resnet50_params, Bottleneck, num_classes, rWeightFlag)
...
def Stage_ResNeXt50_32x4d(num_classes, rWeightFlag=False):
    return ResNet(resnext50_32x4d_params, ResNeXtBlock, num_classes, rWeightFlag)
...
if __name__ == '__main__':
    ...
    # 模型测试
    # model = Stage_ResNet18(num_classes=1000, rWeightFlag=False)
    # model = Stage_ResNet34()
    model = Stage_ResNet50(num_classes=1000, rWeightFlag=True)
    # model = Stage_ResNet101()
    # model = Stage_ResNet152()
    # model = Stage_ResNeXt50_32x4d(num_classes=1000, rWeightFlag=True)
    # model = Stage_ResNeXt101_32x8d(num_classes=1000, rWeightFlag=True)
    # print(model)
