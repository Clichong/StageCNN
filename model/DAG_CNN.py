...
class DagEmbedding(nn.Module):
    def __init__(self, hidden_dim, num_classes=1000):
        ...
        self.conv_x0 = nn.Sequential(
            ...
            nn.Conv2d(hidden_dim // 4, num_classes, kernel_size=(1, 1), stride=(1, 1))
        )
        ...
        self.conv_x1 = nn.Sequential(
            ...
            nn.Conv2d(hidden_dim // 2, num_classes, kernel_size=(1, 1), stride=(1, 1))
        )
        ...
        self.conv_x2 = nn.Sequential(
            ...
            nn.Conv2d(hidden_dim, num_classes, kernel_size=(1, 1), stride=(1, 1))
        )
...
class ResNet(nn.Module):
    def __init__(self, blocks, blockkinds, num_classes):
        ...
        self.dag_embedding = DagEmbedding(self.hidden_dim, num_classes)
...
def DAGCNN_ResNet18(num_classes):
...
def DAGCNN_ResNet50(num_classes):
...
def DAGCNN_ResNeXt50_32x4d(num_classes):
...
if __name__ == '__main__':
    ...
    model = DAGCNN_ResNet50(num_classes=1000)
